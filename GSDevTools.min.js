!(function (e, t) {
    ...
    function w(e, t) {
        if (e.parentNode && (g || T(e))) {
            ...
            return (
                t &&
                    (o
                        ? ((f = f || w(e)), l.setAttribute("width", 0.01), l.setAttribute("height", 0.01), l.setAttribute("transform", "translate(" + r + "," + a + ")"), f.appendChild(l))
    ...
    var g,
        ...
        T = function _setDoc(e) {
            ...
            if (((u = window), (m = new fe()), t)) {
                (r = (g = t).documentElement), (a = t.body), ((v = g.createElementNS("http://www.w3.org/2000/svg", "g")).style.transform = "none");
        ...
        M = function _forceNonZeroScale(e) {
            for (var t, o; e && e !== a; )
                (o = e._gsap) && o.uncache && o.get(e, "x"), o && !o.scaleX && !o.scaleY && o.renderTransform && ((o.scaleX = o.scaleY = 1e-4), o.renderTransform(1, o), t ? t.push(o) : (t = [o])), (e = e.parentNode);
            return t;
        },
        k = [],
        S = [],
        D = function _getDocScrollTop() {
            return u.pageYOffset || g.scrollTop || r.scrollTop || a.scrollTop || 0;
        },
        E = function _getDocScrollLeft() {
            return u.pageXOffset || g.scrollLeft || r.scrollLeft || a.scrollLeft || 0;
        },
        ...
        L = function _placeSiblings(e, t) {
            ...
            if ((d.length || d.push(w(e, 1), w(e, 2), w(e, 3)), (o = l ? f : h), l))
                    ...
                    ? ((r =
                          -(i = (function _getCTM(e) {
                              var t,
                                  o = e.getCTM();
                              return (
                                  o || ((t = e.style[b]), (e.style[b] = "none"), e.appendChild(v), (o = v.getCTM()), e.removeChild(v), t ? (e.style[b] = t) : e.style.removeProperty(b.replace(/([A-Z])/g, "-$1").toLowerCase())),
                                  o || m.clone()
                              );
                          })(e)).e / i.a),
                      (a = -i.f / i.d),
                ...
                if (((r = a = 0), x)) for (n = e.offsetParent, i = e; (i = i && i.parentNode) && i !== n && i.parentNode; ) 4 < (u.getComputedStyle(i)[b] + "").length && ((r = i.offsetLeft), (a = i.offsetTop), (i = 0));
                if ("absolute" !== (s = u.getComputedStyle(e)).position && "fixed" !== s.position) for (n = e.offsetParent; p && p !== n; ) (r += p.scrollLeft || 0), (a += p.scrollTop || 0), (p = p.parentNode);
    ...
    function Pa(e) {
        if (e === ve)
            return (
                (p.left = p.top = 0),
                (p.width = p.right = be.clientWidth || e.innerWidth || s.clientWidth || 0),
                (p.height = p.bottom = (e.innerHeight || 0) - 20 < be.clientHeight ? be.clientHeight : e.innerHeight || s.clientHeight || 0),
                p
            );
        var t = e.ownerDocument || xe,
            o = _(e.pageX) ? (e.nodeType || _(e.left) || _(e.top) ? _e(e)[0].getBoundingClientRect() : e) : { left: e.pageX - Ga(t), top: e.pageY - Fa(t), right: e.pageX - Ga(t) + 1, bottom: e.pageY - Fa(t) + 1 };
        return (
            _(o.right) && !_(o.width) ? ((o.right = o.left + o.width), (o.bottom = o.top + o.height)) : _(o.width) && (o = { width: o.right - o.left, height: o.bottom - o.top, right: o.right, left: o.left, bottom: o.bottom, top: o.top }), o
        );
    }
    function Qa(e, t, o) {
        var n,
            ...
            r = i[o],
            a = e._listeners[t];
        return Z(r) && (n = r.apply(i.callbackScope || e, i[o + "Params"] || [e.pointerEvent])), a && !1 === e.dispatchEvent(t) && (n = !1), n;
    }
    function Ra(e, t) {
        var o,
            n,
    ...
    function Ua(i, r, e, t, a, o) {
        ...
        if (r)
            if (1 !== a && r instanceof Array) {
                if (((c.end = n = []), (l = r.length), $(r[0]))) for (s = 0; s < l; s++) n[s] = ra(r[s], a);
    ...
    function Wa(e, t) {
        for (var o, n = e.length; n--; ) ((o = e[n]).ondragstart = o.onselectstart = t ? null : aa), me.set(o, { lazy: !0, userSelect: t ? "text" : "none" });
    }
    function $a(r, i) {
        ...
        var a,
            ...
            y = 0,
            w = 0;
        z && !1 !== i.force3D ? ((c = "translate3d("), (d = "px,0px)")) : N && ((c = "translate("), (d = "px)")),
            ...
            (this.left = function (e, t) {
                ...
                var o = r.scrollLeft - m,
                    n = h;
                if ((2 < o || o < -2) && !t) return (m = r.scrollLeft), me.killTweensOf(this, { left: 1, scrollLeft: 1 }), this.left(-m), void (i.onKill && i.onKill());
            ...
            (this.top = function (e, t) {
                ...
                var o = r.scrollTop - f,
                    n = g;
                if ((2 < o || o < -2) && !t) return (f = r.scrollTop), me.killTweensOf(this, { top: 1, scrollTop: 1 }), this.top(-f), void (i.onKill && i.onKill());
                (e = -e) < 0 ? ((g = (e - 0.5) | 0), (e = 0)) : w < e ? ((g = (e - w) | 0), (e = w)) : (g = 0), (g || n) && (this._skip || (u[N] = c + -h + "px," + -g + d)), (r.scrollTop = 0 | e), (f = r.scrollTop);
            }),
            ...
            (this.calibrate = function (e) {
                ...
                (f = r.scrollTop),
                    ...
                    (i && r.clientHeight === s && p.offsetHeight === l && v === r.scrollWidth && x === r.scrollHeight && !e) ||
                        ...
                        (t = Na(r)),
                        (i && !e) || ((u.display = "block"), (u.width = "auto"), (u.paddingRight = "0px"), (b = Math.max(0, r.scrollWidth - r.clientWidth)) && (b += parseFloat(t.paddingLeft) + (B ? parseFloat(t.paddingRight) : 0))),
    ...
    function _a(e) {
        if (X() && document.body) {
            ...
            (ve = window),
                ...
                ((ye = fa("div")).style.cssText = "visibility:hidden;height:1px;top:-1px;pointer-events:none;position:relative;clear:both;cursor:grab"),
                (Ae = "grab" === ye.style.cursor ? "grab" : "move"),
                (Se = t && -1 !== t.userAgent.toLowerCase().indexOf("android")),
                (Te = ("ontouchstart" in be && "orientation" in ve) || (t && (0 < t.MaxTouchPoints || 0 < t.msMaxTouchPoints))),
                (n = fa("div")),
                (i = fa("div")),
                (r = i.style),
                (a = s),
        ...
        var o, n, i, r, a;
        me
            ? ((De = me.plugins.inertia), (Ce = me.core.context || function () {}), (c = me.utils.checkPrefix), (N = c(N)), (ze = c(ze)), (_e = me.utils.toArray), (Pe = me.core.getStyleSaver), (z = !!c("perspective")))
    ...
    var me,
        ...
        R = function _getElementBounds(e, t) {
            ...
            if (e === ve)
                (i = Fa(m)),
                    (n = (o = Ga(m)) + (m.documentElement.clientWidth || e.innerWidth || m.body.clientWidth || 0)),
                    (r = i + ((e.innerHeight || 0) - 20 < m.documentElement.clientHeight ? m.documentElement.clientHeight : e.innerHeight || m.body.clientHeight || 0));
            else {
            ...
            return e === t
                ...
                : ((s = (a = getGlobalMatrix(t, !0).multiply(getGlobalMatrix(e))).apply({ x: o, y: i })),
                  ...
                  (c = a.apply({ x: n, y: r })),
                  (d = a.apply({ x: o, y: r })),
                  { left: (o = Math.min(s.x, l.x, c.x, d.x)), top: (i = Math.min(s.y, l.y, c.y, d.y)), width: Math.max(s.x, l.x, c.x, d.x) - o, height: Math.max(s.y, l.y, c.y, d.y) - i });
        },
        H =
    ...
    function Draggable(g, p) {
        ...
        function Ai(e) {
            if (q.autoScroll && q.isDragging && (te || P)) {
                ...
                for (
                    te = !1,
                        We.scrollTop = null != ve.pageYOffset ? ve.pageYOffset : null != de.documentElement.scrollTop ? de.documentElement.scrollTop : de.body.scrollTop,
                        We.scrollLeft = null != ve.pageXOffset ? ve.pageXOffset : null != de.documentElement.scrollLeft ? de.documentElement.scrollLeft : de.body.scrollLeft,
                    ...
                    (t = (o = Ge(c.parentNode)) ? We : c.parentNode),
                        ...
                        j &&
                            ((l = t._gsMaxScrollY - t.scrollTop) < 0
                                ? (s = l)
                                : r > n.bottom - ie && l
                                ? ((te = !0), (s = Math.min(l, (d * (1 - Math.max(0, n.bottom - r) / ie)) | 0)))
                                : r < n.top + oe && t.scrollTop && ((te = !0), (s = -Math.min(t.scrollTop, (d * (1 - Math.max(0, r - n.top) / oe)) | 0))),
                            s && (t.scrollTop += s)),
                        U &&
                            ((l = t._gsMaxScrollX - t.scrollLeft) < 0
                                ? (a = l)
                                : i > n.right - ne && l
                                ? ((te = !0), (a = Math.min(l, (d * (1 - Math.max(0, n.right - i) / ne)) | 0)))
                                : i < n.left + re && t.scrollLeft && ((te = !0), (a = -Math.min(t.scrollLeft, (d * (1 - Math.max(0, i - n.left) / re)) | 0))),
                            a && (t.scrollLeft += a)),
                        o && (a || s) && (ve.scrollTo(t.scrollLeft, t.scrollTop), ge(q.pointerX + a, q.pointerY + s)),
                        (c = t);
            }
            if (P) {
                var p = q.x,
                    u = q.y;
                G
                    ? ((q.deltaX = p - parseFloat(le.rotation)), (q.rotation = p), (le.rotation = p + "deg"), le.renderTransform(1, le))
                    : h
                    ? (j && ((q.deltaY = u - h.top()), h.top(u)), U && ((q.deltaX = p - h.left()), h.left(p)))
                    : W
                    ? (j && ((q.deltaY = u - parseFloat(le.y)), (le.y = u + "px")), U && ((q.deltaX = p - parseFloat(le.x)), (le.x = p + "px")), le.renderTransform(1, le))
                    : (j && ((q.deltaY = u - parseFloat(g.style.top || 0)), (g.style.top = u + "px")), U && ((q.deltaX = p - parseFloat(g.style.left || 0)), (g.style.left = p + "px"))),
                    !f || e || H || (!(H = !0) === Qa(q, "drag", "onDrag") && (U && (q.x -= q.deltaX), j && (q.y -= q.deltaY), Ai(!0)), (H = !1));
            }
            P = !1;
        }
        function Bi(e, t) {
            ...
            g._gsap || (le = me.core.getCache(g)),
                ...
                W
                    ...
                    : ((q.y = parseFloat(g.style.top || ((n = Na(g)) && n.top)) || 0), (q.x = parseFloat(g.style.left || (n || {}).left) || 0)),
                (L || z || X) &&
                    !t &&
                    (q.isDragging || q.isThrowing) &&
                    (X && ((Fe.x = q.x), (Fe.y = q.y), (o = X(Fe)).x !== q.x && ((q.x = o.x), (P = !0)), o.y !== q.y && ((q.y = o.y), (P = !0))),
                    L && (o = L(q.x)) !== q.x && ((q.x = o), G && (q.rotation = o), (P = !0)),
                    z && ((o = z(q.y)) !== q.y && (q.y = o), (P = !0))),
                P && Ai(!0),
                e || ((q.deltaX = q.x - i), (q.deltaY = q.y - r), Qa(q, "throwupdate", "onThrowUpdate"));
        }
        function Ci(a, s, l, o) {
            return (
                null == s && (s = -Ne),
                ...
                Z(a)
                    ? function (e) {
                          ...
                          return a.call(q, (l < e ? l + (e - l) * t : e < s ? s + (e - s) * t : e) * o) * o;
                      }
                    : Xe(a)
                    ? function (e) {
        ...
        function Ei() {
            ...
            (k = !1),
                h
                    ? (h.calibrate(), (q.minX = D = -h.maxScrollLeft()), (q.minY = E = -h.maxScrollTop()), (q.maxX = S = q.maxY = A = 0), (k = !0))
                    : p.bounds &&
                      ((e = Ra(p.bounds, g.parentNode)),
                      G
                          ? ((q.minX = D = e.left), (q.maxX = S = e.left + e.width), (q.minY = E = q.maxY = A = 0))
                          : _(p.bounds.maxX) && _(p.bounds.maxY)
                          ? ((t = Ra(g, g.parentNode)),
                            (q.minX = D = Math.round(Sh(V, "px") + e.left - t.left)),
                            (q.minY = E = Math.round(Sh(Q, "px") + e.top - t.top)),
                            (q.maxX = S = Math.round(D + (e.width - t.width))),
                            (q.maxY = A = Math.round(E + (e.height - t.height))))
                          : ((e = p.bounds), (q.minX = D = e.minX), (q.minY = E = e.minY), (q.maxX = S = e.maxX), (q.maxY = A = e.maxY)),
                ...
                p.liveSnap &&
                    ...
                    G
                        ...
                        ? (X = (function buildPointSnapFunc(l, s, c, d, p, u, g) {
                                  ...
                                  Z(l)
                                      ? function (e) {
                                            ...
                                            return (
                                                ...
                                                (t = l.call(q, e)) !== e && ((e.x = t.x), (e.y = t.y)),
                                                1 !== g && ((e.x *= g), (e.y *= g)),
                          ...
                          })(n ? o : o.points, D, S, E, A, o.radius, h ? -1 : 1))
                        : (U && (L = Ci(n ? o : o.x || o.left || o.scrollLeft, D, S, h ? -1 : 1)), j && (z = Ci(n ? o : o.y || o.top || o.scrollTop, E, A, h ? -1 : 1))));
        }
        function Fi() {
        ...
        function Hi(e, t) {
            ...
            e && De
                ? (!0 === e &&
                      ((o = p.snap || p.liveSnap || {}),
                      (n = Xe(o) || Z(o)),
                      (e = { resistance: (p.throwResistance || p.resistance || 1e3) / (G ? 10 : 1) }),
                      G
                          ? (e.rotation = Ua(q, n ? o : o.rotation, S, D, 1, t))
                          : (U && (e[V] = Ua(q, n ? o : o.points || o.x || o.left, S, D, h ? -1 : 1, t || "x" === q.lockedAxis)),
                            j && (e[Q] = Ua(q, n ? o : o.points || o.y || o.top, A, E, h ? -1 : 1, t || "y" === q.lockedAxis)),
                            (o.points || (Xe(o) && $(o[0]))) && ((e.linkedProps = V + "," + Q), (e.radius = o.radius)))),
                  (q.isThrowing = !0),
                  (r = isNaN(p.overshootTolerance) ? (1 === p.edgeResistance ? 0 : 1 - q.edgeResistance + 0.2) : p.overshootTolerance),
                  e.duration || (e.duration = { max: Math.max(p.minDuration || 0, "maxDuration" in p ? p.maxDuration : 2), min: isNaN(p.minDuration) ? (0 === r || ($(e) && 1e3 < e.resistance) ? 0 : 0.5) : p.minDuration, overshoot: r }),
                  (q.tween = i = me.to(h || g, {
                      inertia: e,
                      data: "_draggable",
                      onComplete: Fi,
                  ...
                  p.fastMode || (h && (h._skip = !0), i.render(1e9, !0, !0), Bi(!0, !0), (q.endX = q.x), (q.endY = q.y), G && (q.endRotation = q.x), i.play(0), Bi(!0, !0), h && (h._skip = !1)))
                : k && q.applyBounds();
        }
        function Ii(e) {
            var t,
                o = B;
            (B = getGlobalMatrix(g.parentNode, !0)), e && q.isPressed && !B.equals(o || new fe()) && ((t = o.inverse().apply({ x: y, y: w })), B.apply(t, t), (y = t.x), (w = t.y)), B.equals(i) && (B = null);
        }
        function Ji() {
            var e,
                t,
                ...
                i = ce ? Ga(de) : 0,
                r = ce ? Fa(de) : 0;
            W && ((le.x = Sh(V, "px") + "px"), (le.y = Sh(Q, "px") + "px"), le.renderTransform()),
                Ii(!1),
                (Ve.x = q.pointerX - i),
                (Ve.y = q.pointerY - r),
                B && B.apply(Ve, Ve),
                ...
                h
                    ...
                    : (pe() ? (Bi(!0, !0), Ei()) : q.applyBounds(),
                      G
                          ? ((e = g.ownerSVGElement ? [le.xOrigin - g.getBBox().x, le.yOrigin - g.getBBox().y] : (Na(g)[ze] || "0 0").split(" ")),
                            (C = q.rotationOrigin = getGlobalMatrix(g).apply({ x: parseFloat(e[0]) || 0, y: parseFloat(e[1]) || 0 })),
                            Bi(!0, !0),
                            (t = q.pointerX - C.x - i),
                            (o = C.y - q.pointerY + r),
                            (T = q.x),
                          ...
                          : ((M = Sh(Q, "px")), (T = Sh(V, "px")))),
                k && n && (S < T ? (T = S + (T - S) / n) : T < D && (T = D - (D - T) / n), G || (A < M ? (M = A + (M - A) / n) : M < E && (M = E - (E - M) / n))),
                (q.startX = T = da(T)),
                (q.startY = M = da(M));
        }
        function Li() {
        ...
        function Mi(e, t) {
            var o;
            if (!u || q.isPressed || !e || (!(("mousedown" !== e.type && "pointerdown" !== e.type) || t) && Re() - se < 30 && Me[q.pointerEvent.type])) O && e && u && Ba(e);
            else {
                if (
                    ((N = pe()),
                    (F = !1),
                    (q.pointerEvent = e),
                    Me[e.type] ? ((b = ~e.type.indexOf("touch") ? e.currentTarget || e.target : de), za(b, "touchend", he), za(b, "touchmove", ue), za(b, "touchcancel", he), za(de, "touchstart", Ea)) : ((b = null), za(de, "mousemove", ue)),
                    (Y = null),
                    (Ee && b) || (za(de, "mouseup", he), e && e.target && za(e.target, "mouseup", he)),
                    (x = ae.call(q, e.target) && !1 === p.dragClickables && !t))
                )
                    return za(e.target, "change", he), Qa(q, "pressInit", "onPressInit"), Qa(q, "press", "onPress"), Wa(J, !0), void (O = !1);
                if (
                    ((R = !(!b || U == j || !1 === q.vars.allowNativeTouchScrolling || (q.vars.allowContextMenu && e && (e.ctrlKey || 2 < e.which))) && (U ? "y" : "x")),
                    (O = !R && !q.allowEventDefault) && (Ba(e), za(ve, "touchforcechange", Ba)),
                    ...
                    !g.parentNode || !q.autoScroll || h || G || !g.parentNode._gsMaxScrollX || ye.parentNode || g.getBBox || ((ye.style.width = g.parentNode.scrollWidth + "px"), g.parentNode.appendChild(ye)),
                    Ji(),
                    ...
                    for (o = J.length; -1 < --o; ) me.set(J[o], { cursor: p.activeCursor || p.cursor || ("grab" === Ae ? "grabbing" : Ae) });
                Qa(q, "press", "onPress");
            }
        }
        function Qi(e) {
        ...
        function Ri(e) {
            ...
            if (((i || (n && !1 !== q.vars.suppressClickOnDrag)) && e.stopImmediatePropagation && e.stopImmediatePropagation(), o && (!q.pointerEvent || !q.pointerEvent.defaultPrevented) && (!i || (s && !a))))
                return s && i && (c = se), void (I = se);
            (q.isPressed || n || o) && ((s && e.detail && o && !r) || Ba(e)), o || n || F || (e && e.target && (q.pointerEvent = e), Qa(q, "click", "onClick"));
        }
        function Si(e) {
        ...
        var u,
            ...
            ue = function onMove(e) {
                ...
                if (u && !ke && q.isPressed && e) {
                    ...
                    (o = Ve.x),
                    (n = Ve.y),
                    (((r = Math.abs(o - y)) !== (a = Math.abs(n - w)) && (K < r || K < a)) || (Se && R === Y)) &&
                        ((Y = a < r && U ? "x" : "y"),
                        R && Y !== R && za(ve, "touchforcechange", Ba),
                        !1 !== q.vars.lockAxisOnTouchScroll && U && j && ((q.lockedAxis = "x" === Y ? "y" : "x"), Z(q.vars.onLockAxis) && q.vars.onLockAxis.call(q, s)),
                        Se && R === Y))
                        ? he(s)
                        : ((O = q.allowEventDefault || (R && (!Y || R === Y)) || !1 === s.cancelable ? O && !1 : (Ba(s), !0)), q.autoScroll && (te = !0), ge(e.pageX, e.pageY, l));
                } else O && e && u && Ba(e);
            },
            ge = function setPointerPosition(e, t, o) {
                ...
                (q.pointerX = e),
                    ...
                    ce && ((e -= Ga(de)), (t -= Fa(de))),
                    G
                        ? ((a = Math.atan2(C.y - t, e - C.x) * Be), 180 < (s = q.y - a) ? ((M -= 360), (q.y = a)) : s < -180 && ((M += 360), (q.y = a)), (r = q.x !== T || Math.abs(M - a) > K ? ((q.y = a), T + (M - a) * c) : T))
                        : (B && ((l = e * B.a + t * B.c + B.e), (t = e * B.b + t * B.d + B.f), (e = l)),
                          (i = t - w) < K && -K < i && (i = 0),
                          (n = e - y) < K && -K < n && (n = 0),
                          (q.lockAxis || q.lockedAxis) &&
                              (n || i) &&
                              ((l = q.lockedAxis) || ((q.lockedAxis = l = U && Math.abs(n) > Math.abs(i) ? "y" : j ? "x" : null), l && Z(q.vars.onLockAxis) && q.vars.onLockAxis.call(q, q.pointerEvent)),
                              "y" === l ? (i = 0) : "x" === l && (n = 0)),
                          (r = da(T + n * c)),
                          (a = da(M + i * c))),
                    (L || z || X) && (q.x !== r || (q.y !== a && !G)) && (X && ((Fe.x = r), (Fe.y = a), (l = X(Fe)), (r = da(l.x)), (a = da(l.y))), L && (r = da(L(r))), z && (a = da(z(a)))),
                    k && (S < r ? (r = S + Math.round((r - S) * d)) : r < D && (r = D + Math.round((r - D) * d)), G || (A < a ? (a = Math.round(A + (a - A) * d)) : a < E && (a = Math.round(E + (a - E) * d)))),
                    (q.x === r && (q.y === a || G)) ||
                        (G ? ((q.endRotation = q.x = q.endX = r), (P = !0)) : (j && ((q.y = q.endY = a), (P = !0)), U && ((q.x = q.endX = r), (P = !0))),
                        o && !1 === Qa(q, "move", "onMove")
                            ? ((q.pointerX = p), (q.pointerY = u), (M = g), (q.x = h), (q.y = f), (q.endX = m), (q.endY = v), (q.endRotation = x), (P = b))
                            : !q.isDragging && q.isPressed && ((q.isDragging = F = !0), Qa(q, "dragstart", "onDragStart")));
            },
            he = function onRelease(e, t) {
                if (
                    ...
                    if (
                        (b ? (Aa(b, "touchend", onRelease), Aa(b, "touchmove", ue), Aa(b, "touchcancel", onRelease), Aa(de, "touchstart", Ea)) : Aa(de, "mousemove", ue),
                        Aa(ve, "touchforcechange", Ba),
                        (Ee && b) || (Aa(de, "mouseup", onRelease), e && e.target && Aa(e.target, "mouseup", onRelease)),
                        (P = !1),
                        l && ((ee = Oe = Re()), (q.isDragging = !1)),
                        xa(Ai),
                        x && !c)
                    )
                        return e && (Aa(e.target, "change", onRelease), (q.pointerEvent = s)), Wa(J, !1), Qa(q, "release", "onRelease"), Qa(q, "click", "onClick"), void (x = !1);
                    ...
                    return (
                        c && s
                            ...
                            : s && !l
                            ? ((O = !1),
                              N && (p.snap || p.bounds) && Hi(p.inertia || p.throwProps),
                                  ...
                                  (a = function syntheticClick() {
                                      se === I ||
                                          ...
                                          (r.click
                                              ? r.click()
                                              : de.createEvent &&
                                                ((i = de.createEvent("MouseEvents")).initMouseEvent("click", !0, !0, ve, 1, q.pointerEvent.screenX, q.pointerEvent.screenY, q.pointerX, q.pointerY, !1, !1, !1, !1, 0, null),
                                                r.dispatchEvent(i)));
                                  }),
                                  Se || s.defaultPrevented || me.delayedCall(0.05, a)))
                            : (Hi(p.inertia || p.throwProps),
                              q.allowEventDefault || !s || (!1 === p.dragClickables && ae.call(q, s.target)) || !l || (R && (!Y || R !== Y)) || !1 === s.cancelable ? (O = !1) : ((O = !0), Ba(s)),
                              Qa(q, "release", "onRelease")),
        ...
        return (
            ...
            (e.startDrag = function (e, t) {
                ...
                Mi(e || q.pointerEvent, !0),
                    t &&
                        ...
                        ((o = Pa(e || q.pointerEvent)), (n = Pa(g)), (i = Si({ x: o.left + o.width / 2, y: o.top + o.height / 2 })), (r = Si({ x: n.left + n.width / 2, y: n.top + n.height / 2 })), (y -= i.x - r.x), (w -= i.y - r.y)),
                    q.isDragging || ((q.isDragging = F = !0), Qa(q, "dragstart", "onDragStart"));
            }),
            (e.drag = ue),
            ...
            (e.getDirection = function (e, t) {
                var o,
                    ...
                    a,
                    s,
                    l = "velocity" === e && De ? e : $(e) && !G ? "element" : "start";
                return (
                    "element" === l && ((a = Pa(q.target)), (s = Pa(e))),
                    (o = "start" === l ? q.x - T : "velocity" === l ? De.getVelocity(g, V) : a.left + a.width / 2 - (s.left + s.width / 2)),
                    G
                        ? o < 0
                            ? "counter-clockwise"
                            : "clockwise"
                        : ((t = t || 2),
                          (n = "start" === l ? q.y - M : "velocity" === l ? De.getVelocity(g, Q) : a.top + a.height / 2 - (s.top + s.height / 2)),
            ...
            (e.applyBounds = function (e, t) {
                ...
                if ((Bi(!0), Ei(), k && !pe())) {
                    if (
                        ...
                        S < o ? (o = S) : o < D && (o = D),
                        A < n ? (n = A) : n < E && (n = E),
                        (q.x !== o || q.y !== n) && ((i = !0), (q.x = q.endX = o), G ? (q.endRotation = o) : (q.y = q.endY = n), Ai((P = !0)), q.autoScroll && !q.isDragging))
                    )
                        for (
                            La(g.parentNode),
                                r = g,
                            ...
                            (a = (s = Ge(r.parentNode)) ? We : r.parentNode), j && a.scrollTop > a._gsMaxScrollY && (a.scrollTop = a._gsMaxScrollY), U && a.scrollLeft > a._gsMaxScrollX && (a.scrollLeft = a._gsMaxScrollX), (r = a);
            ...
            (e.update = function (e, t, o) {
                if (t && q.isPressed) {
                    ...
                    r.apply({ x: n.e - i.x, y: n.f - i.y }, i), (q.x -= i.x - r.e), (q.y -= i.y - r.f), Ai(!0), Ji();
                }
                var a = q.x,
                    s = q.y;
                return (
                    ...
                    q.isPressed && !t && ((U && 0.01 < Math.abs(a - q.x)) || (j && 0.01 < Math.abs(s - q.y) && !G)) && Ji(),
                    q.autoScroll && (La(g.parentNode, q.isDragging), (te = q.isDragging), Ai(!0), Ia(g, Qi), Ha(g, Qi)),
                    q
                );
            }),
            (e.enable = function (e) {
                ...
                if ((!1 !== p.cursor && (i.cursor = p.cursor || Ae), me.utils.checkPrefix("touchCallout") && (i.touchCallout = "none"), "soft" !== e)) {
                    for (
                        ta(J, U == j ? "none" : (p.allowNativeTouchScrolling && (g.scrollHeight === g.clientHeight) == (g.scrollWidth === g.clientHeight)) || p.allowEventDefault ? "manipulation" : U ? "pan-y" : "pan-x"), o = J.length;
                        -1 < --o;
                        ...
                        (n = J[o]),
                            ...
                            za(n, "click", Ri, !0),
                            me.set(n, i),
                            n.getBBox && n.ownerSVGElement && U != j && me.set(n.ownerSVGElement, { touchAction: p.allowNativeTouchScrolling || p.allowEventDefault ? "manipulation" : U ? "pan-y" : "pan-x" }),
                ...
                return (
                    Ha(g, Qi),
                    (u = !0),
                    De && "soft" !== e && De.track(h || g, W ? "x,y" : G ? "rotation" : "top,left"),
                    (g._gsDragID = t = "d" + Ie++),
                    (He[t] = q),
            ...
            (e.disable = function (e) {
                ...
                return (
                    Ia(g, Qi),
                    (u = !1),
                    De && "soft" !== e && (De.untrack(h || g, W ? "x,y" : G ? "rotation" : "top,left"), q.tween && q.tween.kill()),
                    h && h.disable(),
                    xa(Ai),
    ...
    !(function _setDefaults(e, t) {
        for (var o in t) o in e || (e[o] = t[o]);
    })(V.prototype, { pointerX: 0, pointerY: 0, startX: 0, startY: 0, deltaX: 0, deltaY: 0, isDragging: !1, isPressed: !1 }),
        (V.zIndex = 1e3),
        (V.version = "3.12.3"),
    ...
    function Ub(t, e, o, n) {
        var i, r;
        if ((("mousedown" !== e && "mouseup" !== e) || (t.style.cursor = "pointer"), "mousedown" === e && (r = xb(t.onpointerdown) ? (xb(t.ontouchstart) ? null : "touchstart") : "pointerdown")))
            return (
                (i = function handler(e) {
                    "select" !== e.target.nodeName.toLowerCase() && e.type === r ? (e.stopPropagation(), Ue && (e.preventDefault(), o.call(t, e))) : e.type !== r && o.call(t, e), (Ue = !0);
                }),
    ...
    function Wb(e, t, o, n) {
        ...
        n && ((i = Lb("option", e)).setAttribute("value", t), (i.innerHTML = o.innerHTML = ub(n) ? n : t), (e.selectedIndex = r.length - 1));
    }
    function Xb(e, t, o) {
        var n = e.options,
        ...
        (Q = e || tb()),
            U ||
                (Q &&
                    ...
                    (J = Q.core.Animation),
                    (ne = Q.timeline({ data: "indy", autoRemoveChildren: !0, smoothChildTiming: !0 })).kill(),
                    (ne._dp = 0),
                    ne.to({}, { duration: 1e12 }),
                    (q = Q.timeline({ data: "root", id: "Global Timeline", autoRemoveChildren: !1, smoothChildTiming: !0, parent: ne }, 0)),
                    (ee = Q.to(q, { duration: 1, time: 1, ease: "none", data: "root", id: "_rootTween", paused: !0, immediateRender: !1, parent: ne }, 0)),
                    ...
                    (ie = function _delayedCall(e, t, o, n) {
                        return Q.to(t, { delay: e, duration: 0, onComplete: t, onReverseComplete: t, onCompleteParams: o, onReverseCompleteParams: o, callbackScope: n, parent: ne }, ne._time);
                    })(0.01, function () {
    ...
    var Q,
        ...
        de =
            ((function (e) {
                var t = "undefined" != typeof window,
                    o = 0 === (t ? window.location.href : "").indexOf(Ab(102, 105, 108, 101, 58, 47, 47)) || -1 !== e.indexOf(Ab(108, 111, 99, 97, 108, 104, 111, 115, 116)) || ce.test(e),
                    n = [
                        W,
                        G,
                        Ab(99, 111, 100, 101, 112, 101, 110, 46, 105, 111),
                        Ab(99, 111, 100, 101, 112, 101, 110, 46, 112, 108, 117, 109, 98, 105, 110, 103),
                        Ab(99, 111, 100, 101, 112, 101, 110, 46, 100, 101, 118),
                        Ab(99, 111, 100, 101, 112, 101, 110, 46, 97, 112, 112),
                        Ab(99, 111, 100, 101, 112, 101, 110, 46, 119, 101, 98, 115, 105, 116, 101),
                        ...
                        Ab(99, 111, 100, 101, 99, 97, 110, 121, 111, 110, 46, 110, 101, 116),
                        Ab(116, 104, 101, 109, 101, 102, 111, 114, 101, 115, 116, 46, 110, 101, 116),
                        ...
                        Ab(99, 111, 100, 101, 115, 97, 110, 100, 98, 111, 120, 46, 105, 111),
                        ...
                        Ab(109, 111, 116, 105, 111, 110, 116, 114, 105, 99, 107, 115, 46, 99, 111, 109),
                        Ab(115, 116, 97, 99, 107, 111, 118, 101, 114, 102, 108, 111, 119, 46, 99, 111, 109),
                        Ab(115, 116, 97, 99, 107, 101, 120, 99, 104, 97, 110, 103, 101, 46, 99, 111, 109),
                        Ab(115, 116, 117, 100, 105, 111, 102, 114, 101, 105, 103, 104, 116, 46, 99, 111, 109),
                        Ab(119, 101, 98, 99, 111, 110, 116, 97, 105, 110, 101, 114, 46, 105, 111),
                        ...
                        if (t)
                            if ("loading" === document.readyState || "interactive" === document.readyState) document.addEventListener("readystatechange", checkWarn);
                                ...
                                t &&
                                    ...
                                    (console.log(Ab(37, 99, 87, 97, 114, 110, 105, 110, 103), Ab(102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 51, 48, 112, 120, 59, 99, 111, 108, 111, 114, 58, 114, 101, 100, 59)),
                                    console.log(
                                        Ab(65, 32, 116, 114, 105, 97, 108, 32, 118, 101, 114, 115, 105, 111, 110, 32, 111, 102, 32) +
                                            F +
                                            Ab(
                                                32,
                                                105,
                                    ...
                                    console.log(
                                        ...
                                        Ab(102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 49, 54, 112, 120, 59, 99, 111, 108, 111, 114, 58, 35, 52, 101, 57, 56, 49, 53)
                                    ),
                ...
                o ||
                    setTimeout(function () {
                        t && (window.location.href = Ab(104, 116, 116, 112, 115, 58, 47, 47) + W + Ab(47, 114, 101, 113, 117, 105, 114, 101, 115, 45, 109, 101, 109, 98, 101, 114, 115, 104, 105, 112, 47) + "?plugin=" + F + "&source=trial");
                    }, 4e3);
        ...
        Ze = function GSDevTools(r) {
            U || (ac(), Q || console.warn("Please gsap.registerPlugin(GSDevTools)")),
                (this.vars = r = r || {}),
                r.animation &&
                    (
            ...
            function mo(e, t) {
                return !1 !== r.persist && he && sessionStorage.setItem("gs-dev-" + e + r.id, t), t;
            }
            function no(e) {
                var t;
                if (!1 !== r.persist && he) return (t = sessionStorage.getItem("gs-dev-" + e + r.id)), "animation" === e ? t : "loop" === e ? "true" === t : parseFloat(t);
            }
            function Uo(c, d, p) {
                return function (e) {
                    var t,
            ...
            function fp() {
                var e,
                    ...
                    o = (function _getChildrenOf(e, t) {
                        for (var o = [], n = 0, i = Q.core.Tween, r = e._first; r; ) r instanceof i ? r.vars.id && (o[n++] = r) : (t && r.vars.id && (o[n++] = r), (n = (o = o.concat(_getChildrenOf(r, t))).length)), (r = r._next);
                        return o;
                    })(a && !r.globalSync ? a : q, !0),
                    n = A.children,
                    i = 0;
                for (a && !r.globalSync ? o.unshift(a) : r.hideGlobalTimeline || o.unshift(q), t = 0; t < o.length; t++)
            ...
            function gp(e) {
                ...
                if (
                    ...
                    e.scrollTrigger && console.warn("GSDevTools can't work with ScrollTrigger-based animations; either the scrollbar -OR- the GSDevTools scrubber can control the animation."),
                    e !== i)
                ) {
                    if (
                        ...
                        (M.style.left = S + "%"),
                        (k.style.left = D + "%"),
                        c && (mo("animation", i.vars.id), mo("in", S), mo("out", D)),
                        (s = 0),
                        (o = r.maxDuration || Math.min(1e3, Ob(i))),
                        i === q || r.globalSync)
                    ) {
                        if ((Yb(), (v = ee), te && te !== p && console.warn("Error: GSDevTools can only have one instance that's globally synchronized."), (te = p), i !== q))
                        ...
                        if ((te === p && (te = null), (s = Math.min(S * i.duration(), i.time())), i !== a && a)) {
                            ...
                            o < l - s && (l = s + o), a.pause(s), (v = Q.to(a, { duration: l - s, time: l, ease: "none", data: "root", parent: ne }, ne._time));
            ...
            function jp() {
                ...
                v.timeScale(t),
                    mo("timeScale", t),
                    C ||
                        (v.progress() >= D / 100 ? ((e = v._targets && v._targets[0]) === i && e.seek(s + ((l - s) * S) / 100), v.progress(S / 100, !0).pause()) : v.pause(),
                        ie(0.01, function () {
                            return v.resume();
                        })),
                    (X.innerHTML = t + "x"),
            ...
            function rp(e) {
                ...
                t && ((t._inProgress = no("in") || 0), (t._outProgress = no("out") || 100)), r.paused && I(), (i = null), gp(a || t || q);
                var o = r.timeScale || no("timeScale"),
                    n = t === i;
                o && (Wb(z, o, X, o + "x"), v.timeScale(o)),
                    100 === (S = ("inTime" in r ? Qb(r.inTime, i, 0, 0) : n ? t._inProgress : 0) || 0) && !r.animation && t && (gp(q), (S = Qb(r.inTime, i, 0, 0) || 0)),
                    S && ((M.style.left = S + "%"), (M.style.display = k.style.display = "block")),
                    (D = ("outTime" in r ? Qb(r.outTime, i, 100, S) : n ? t._outProgress : 0) || 100) < S && (D = 100),
                    100 !== D && ((k.style.left = D + "%"), (M.style.display = k.style.display = "block")),
                    (d = "loop" in r ? r.loop : no("loop")) && dp(!0),
                    r.paused && v.progress(S / 100, !0).pause(),
                    se && i === q && le && r.globalSync && !C && v.time(-le, !0),
                    Y(!0);
            }
            var u,
                g,
                ...
                n = (function _createRootElement(e, t, o) {
                    ...
                    return (
                        ...
                        o &&
                            ...
                            n.style.width && Q.set(n, { xPercent: -50, left: "50%", right: "auto", data: "root" }).kill()),
                ...
                N = V.create(M, {
                    ...
                    onRelease: function onRelease() {
                        S < 0 && (S = 0), Mb(), (M.style.left = S + "%"), mo("in", S), Q.set(M, { x: 0, data: "root", display: "block" }), C || v.resume();
                    },
                })[0],
                R = V.create(k, {
                    type: "x",
                    ...
                    onRelease: function onRelease() {
                        100 < D && (D = 100), Mb(), (k.style.left = D + "%"), mo("out", D), Q.set(k, { x: 0, data: "root", display: "block" }), m || (H(), v.resume());
                    },
                })[0],
                        ...
                        100 < o && (o = 100),
                            D <= o
                                ? !d || v.paused() || B.isDragging
                                    ? ((o === D && -1 !== i._repeat) || ((o = D), v.progress(o / 100)), !C && (D < 100 || 1 === i.totalProgress() || -1 === i._repeat) && I())
                                    : n ||
                                      ((o = S),
                                      (t = v._targets && v._targets[0]) === i && t.seek(s + ((l - s) * S) / 100),
                                      0 < i._repeat && !S && 100 === D ? 1 === i.totalProgress() && v.totalProgress(0, !0).resume() : v.progress(o / 100, !0).resume())
                ...
                F = Q.to([lo(".gs-bottom"), lo(".gs-top")], { duration: 0.3, autoAlpha: 0, y: 50, ease: "power2.in", data: "root", paused: !0, parent: ne }, ne._time),
                W = !1,
                G = ie(1.3, np).pause();
            Ub(A, "change", ip),
                Ub(A, "mousedown", fp),
                ...
                Ub(P, "mousedown", ep),
                Ub(z, "change", jp),
                "auto" === r.visibility ? (Ub(n, "mouseout", mp), Ub(n, "mouseover", op)) : "hidden" === r.visibility && ((W = !0), F.progress(1)),
                !1 !== r.keyboard &&
                    (oe && r.keyboard
                          ...
                          Ub(
                              ...
                              (e = function keyboardHandler(e) {
                                  ...
                                  32 === o
                                      ? O()
                                      : 38 === o
                                      ? ((t = parseFloat(Xb(z, -1, X))), v.timeScale(t), mo("timeScale", t))
                                      : 40 === o
                                      ? ((t = parseFloat(Xb(z, 1, X))), v.timeScale(t), mo("timeScale", t))
                                      : 37 === o
                                      ? cp()
                                      ...
                                      : 73 === o
                                      ? ((S = 100 * v.progress()), mo("in", S), (M.style.left = S + "%"), Y(!0))
                                      : 79 === o && ((D = 100 * v.progress()), mo("out", D), (k.style.left = D + "%"), Y(!0));
                              })
                          ))),
                Q.set(x, { xPercent: -50, x: 0, data: "root" }),
                Q.set(M, { xPercent: -100, x: 0, data: "root" }),
                (M._gsIgnore = k._gsIgnore = x._gsIgnore = t._gsIgnore = P._gsIgnore = !0),
                    ...
                    te === p &&
                        ...
                        (function updateRootDuration() {
                            ...
                            i === q &&
                                ...
                                1e3 === (o = Math.min(1e3, q.duration())) && (o = Math.min(1e3, Ob(q))),
                                1 != (t = ee.duration() / o) &&
                                    o &&
                                    ((S *= t), D < 100 && (D *= t), ee.seek(0), (ee.vars.time = o), ee.invalidate(), ee.duration(o), ee.time(e), (_.innerHTML = o.toFixed(2)), (M.style.left = S + "%"), (k.style.left = D + "%"), Y(!0)));
                        })());
                }),
